...
{
    public class DataGridViewModel : WidgetViewModel
    {
        ...
        public DataGridViewModel(WidgetConfig config, DashboardService dashboardService)
        ...
        {
            return new DataGridView { BindingContext = this };
        }
    }
}